...
Contract prepared on 2026-09-10. This file specifies the completed architecture
and required population format. Pilot release is still pending the remaining
exact independent reviews; the final handoff and integration receipt establish
the released revision. Counts describe the authored pilot, not a quota.
...
ownership. The registry and allocation become final at the completed handoff.
...
rendered framing requires affected text review. Replaced image bytes require
