...
Naturally, I wanted to think through what my own terminal values were. Due to an abundance of free time and LLMs making coding way faster & more entertaining, [I built a small web app last week](<https://vanshkumar.net/terminal-desires-ranker/>) to do pairwise comparisons to figure this out. Give it a try if you want.

Here are my results:

![Terminal desires ranking results](/assets/terminal-results.png)
...
One answer is [with another set of questions](<https://substack.com/@rickfoerster/note/c-81611201?>):
