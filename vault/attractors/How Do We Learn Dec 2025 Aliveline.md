...
So for December I chose to try to **have and publish an original insight**. I began the aliveline on December 2 and was intending to give myself until January 2, but life intervened and I wrapped it up on January 31.

I had zero neuroscience background going into this, but wanted to jump start progress on one of my two main quests – **understanding how we learn.**

A more detailed definition, from the first day of the aliveline:
...
I ended up working on the neural dynamics of *C. elegans* — tiny worms with ~300 neurons, one of the simplest animals with a nervous system. The specific experiment was extending a method to extract low-D neural loops representing locomotion in their brains to freely moving worms (the original paper had found clean loops in immobilized worms). I was able to recover loops in some of the worm neural traces I tested, though not all, and the loops were all significantly noisier. Further tests would be needed to fully quantify exactly how loop-like the structures are that I found. The research literature qualitatively agrees – others have also found it difficult to find clean locomotion loops in freely moving worms, because there is just so much going on in their brains.
...
Having an absurd objective like this was *extremely* motivating. It forced me to take a research-first/question-first approach to learning things, which was way more fun and got me ramped up in the field very quickly. LLMs helped massively on that front, along with on the coding front.

And while the final experiment didn't end up with positive results and I had *a lot* of hiccups along the way, I still feel proud that I was able to go from vague ideas to a real hypothesis & run a real experiment with real results to test one part of it in just two months. And more importantly, it was fun! I am excited to continue my quest of understanding the brain and also extremely interested in using LLMs to accelerate science more broadly.
...
[This is Claude's full list of suggestions](https://github.com/vanshkumar/LOOPER-freely-moving-worms/blob/main/meta_reflections/CLAUDE_SUGGESTIONS_V2.md) and this is one specifically thinking through [when & how to make an LLM co-scientist more autonomous](https://github.com/vanshkumar/LOOPER-freely-moving-worms/blob/main/meta_reflections/LET_EM_LOOSE.md). The mental model of me being the PI, Claude Code being the senior researcher, and Codex being the grad student/builder is a very useful one.

I am looking forward to implementing these suggestions and having LLMs help me improve the co-science system itself when I start my next project. I have a feeling that will be quite soon.
