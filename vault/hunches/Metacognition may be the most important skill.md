...
- Setting aside time to define an ambitious vision, principles, values, etc
- Meditation
- Anki, if cards are written for understanding & improved over time
- [[Write about what you read]]
- Reading & knowledge itself compounds – the more you have read and understood, the larger the web of topics you can ask questions about & find relationships between