...
- Learning materials
	- First are those that make up practical life curriculum (pouring, cutting, etc)
	- Then, sensorial materials (materials w difference in a single sense, eg boxes that differ ONLY in size)
	- Literary curriculum – learning writing before reading, the breaking down of the constituent skills of writing (pencil control, letter formation, spelling) before the child actually writes words on paper, phonics, grammar thru materials
	- Mathematics – "quantities 0–10 and their symbols are introduced separately before being combined, and large quantities and symbols (tens, hundreds and thousands) and fractions are introduced soon after, all through concrete materials. Operations (addition, subtraction, multiplication, division, the calculation of square roots) are again introduced using concrete materials, which the child can choose to stop using when he is able to succeed without that concrete support"
	  
	- Overall – learning thru movement, concrete foundation, materials have an element of self-correction so the child can figure out the issue w/o teacher involvement
- Self-directed engagement w materials
	- Kids have to set up the materials themselves, use it as long as they like, and then put it back themselves (internal work cycle)
	- Larger period of 3h that kids are free to work with materials as they like (external work cycle)
	- Teacher is guide – can help students having trouble choosing materials, intro new challenges to ready students, do small group lessons
- No external rewards system (grades, points, stars, etc)
- Reduced emphasis on academic testing and lack of competition between students
- Grouping done based on shared interest rather than academic ability
- Mixed-age classrooms (3-6, 6-9, 9-12 usually) to foster child-to-child tutoring

Randomized trial in Lillard and Else-Quest, with actually good study design found:

>Although group differences were not found for all outcome measures, where they were found they favoured the Montessori group. For 5-year olds, significant group differences were found for certain academic skills (namely letter-word identification, phonological decoding ability, and math skills), a measure of executive function (the card sort task), social skills (as measured by social reasoning and positive shared play) and theory of mind (as measured by a false-belief task). For 12-year olds, significant group differences were found on measures of story writing and social skills. Furthermore, in a questionnaire that asked about how they felt about school, responses of children in the Montessori group indicated that they felt a greater sense of community. The authors concluded that 'at least when strictly implemented, Montessori education fosters social and academic skills that are equal or superior to those fostered by a pool of other types of schools'

Limitations of the study are that it used just one Montessori school (where a lottery was in place in the school system to allow for randomization)

Fidelity of adherence to the Montessori method is important.
...
^ This was not a randomized trial, though it did match group on key variables such as parental education

>In a move to explore the role of the Montessori materials further, a more recent experimental study removed supplementary materials, to leave just the Montessori materials, from two of the three classrooms in a Montessori school that served 3–6-year olds. Over a period of 4 months children in the classrooms from which supplementary materials were removed made significantly greater gains than children from the unchanged classroom on tests of letter-word identification and executive function, although not on measures of vocabulary, theory of mind, maths, or social problem-solving. The authors acknowledge weaknesses in the study design, including the small number of participants (just 52 across the three classrooms) and the short duration.

Variations in fidelity make it really hard to evaluate studies. But one implication is that "Montessori" is clearly a spectrum.

Studies that claim "sleeper effects" of Montessori, appearing later in adolescence, are sketchy also as a result.

Not much high quality studies on the effects on creativity. One (below) found more emphasis on physical world, but not a big diff between Montessori v conventional. Other in France for 7-12 year olds found that Montessori scored higher than conventional

>They wrote that 'The study does, however, support the notion that differing preschool educational environments yield different outcomes' and 'Montessori children responded to the emphasis in their programme upon the physical world and upon a de nition of school as a place of work; the Nursery School children responded on their part to the social emphasis and the opportunity for spontaneous expression of feeling'

None of the studies above try to pinpoint which part of Montessori might be accounting for positive effects. Study did find that practical life materials can be efficacious outside Montessori classroom. Showed it can help with fine motor control

A study that showed higher intrinsic motivation for Montessori middle school students:
...
>To date there have been very few methodologically robust evaluations.

The lack of ability to randomize or properly blind (parents, teachers) in the studies is a huge issue, and it's quite unclear how to get around this.
...
Sample:
>The sample for the current study consisted of 543 fourth- and eighth-grade students (i.e., 291 fourth-graders and 252 eighth-graders) in a large urban district in western New York. Four public schools were selected for participation: Montessori, Open Magnet (OM), Structured Magnet (SM), and Traditional Non-Magnet (TNM) schools. Schools were selected based on grossly similar school profiles provided by the New York State Education Department. To control for demographic differences be- tween school types, schools were matched on gender, ethnicity, and socioeconomic status (SES). SES was determined using the federal formula for free and reduced lunch. Based on the formula, students were categorized by the district as “low income” or “not low income.” Overall, approximately 67 percent of the total sample was identified as low income (i.e., 69 percent of grade 4 and 64 percent of grade 8). White students constituted approximately 47 percent of the sample, with African American, Hispanic, and Other students making up the category of “Minority.”

New York State standardized exams were used to assess achievement. Compiled as part of each school's annual evaluation of students.
...
Limitations:
- Only used one school from each program type
...
- I haven't really defined "executive function", "social skills", or "intrinsic motivation for future independent learning" particularly well. They need to be defined clearly.
...
[Effects of Montessori Education on the Academic, Cognitive, and Social Development of Disadvantaged Preschoolers: A Randomized Controlled Study in the French Public-School System](https://pubmed.ncbi.nlm.nih.gov/33932226/)
- Ages 3-6, tested over 3 yrs
- Adapted version of Montessori (fewer materials, shorter work periods, limited teacher Montessori training) has no benefit, except for in reading. Notably executive fcn & social skills were measured, and longitudinally (3 yrs)
- "Overall, our results call for preregistered studies investigating high-fidelity Montessori education in randomized controlled designs" lol

[Montessori Preschool Elevates and Equalizes Child Outcomes: A Longitudinal Study](https://pubmed.ncbi.nlm.nih.gov/29163248/)
- Ages 3-6, 141 kids total in 2 groups, tested over 3 yrs
- "An ANOVA showed that the Montessori children were relatively more positive about school-related activities than were the control children, F(1,116)= 5.69 p= 0.02, η2 = 0.05"
	- Differences in variation b/w the two groups re: liking academic tasks is significant. Small to medium effect size (5% of variation in prefs can be explained by Montessori or not).
- ![[Screenshot 2025-03-07 at 09.15.09.png]]
...
- This also measured executive fcn, social skills. come back to this

Is it meaningful to test for stuff like intrinsic motivation for independent learning in 3-6 year olds? Unclear. I guess just liking school is enough?

[Shunned and Admired: Montessori, Self-Determination, and a Case for Radical School Reform](https://link.springer.com/article/10.1007/s10648-019-09483-3)
- Self-determination theory & the ideas of Montessori converge quite well
	- Self determination theory component are autonomy, competence, relatedness
- If you believe in overjustifiction / undermining effect, then it's clear how a Montessori style system of no extrinsic rewards for learning => higher intrinsic motivation for that
- The combo of no extrinsic rewards + achievement/mastery focus should lead to highest intrinsic motivation based on current psych literature

The study that the positive case rests on: [Evaluating Montessori education](https://files.eric.ed.gov/fulltext/ED622858.pdf)
- 53 control, 59 Montessori students
- Nothing really related to intrinsic motivation, but benefits shown on social skills, exec fcn, theory of mind, etc. Effect sizes are pretty solid, medium in most cases and large in a couple.
- On a questionnaire regarding their feelings about school, Montessori children indicated having a greater sense of community, responding more positively to items such as, “Students in my class really care about each other” and “Students in this class treat each other with respect.”
...
- Very "do what you love" vs "love what you do" coded
- The present study shows that intrinsic motivation does not lead to higher achievement in mathematics, but does not speak specifically to the impact of intervention on intrinsic motivation and achievement. It may still be possible to improve intrinsic motivation through intervention, but at the population level, intrinsic motivation does not “naturally” increase achievement in mathematics. It could also be that within the population, the relation between intrinsic motivation and performance in mathematics differs as a function of ability level (Cleary & Chen, 2009; J~ ogi, Kikas, Lerkkanen, & M€ agi, 2015) or the nature of the mathematics skills (Cerasoli, Nicklin, & Ford, 2014). For instance, intrinsic motivation more likely predicts the quality (i.e., complex task that seeks more skills and commands personal investment) than the quantity (i.e., task with less personal cognitive investment) of achievement (Cerasoli et al., 2014).
- Finally, an important feature of the present results is that achievement level in mathematics was fairly well established early in primary school, and subsequently predicts intrinsic motivation toward mathematics. This stability of achievement and the ensuing consistent motivational trend in mathematics underscore the need to document the early school years as a crucial period for the assessment and fostering of early numeracy.

So maybe one way to refute a sub version of my hypothesis would be that Montessori's autonomy aspects don't actually matter that much and it's more the focus on competence/achievement/mastery? And you can recreate that outside of Montessori if your kid is smart & goes to a strong public school?
...
- Grades 6-8
- ![[Screenshot 2025-03-07 at 10.52.47.png]]
...
What's the inverse of my hypothesis?
	Montessori schooling is equally or less effective than traditional schooling at fostering intrinsic motivation in students for independent learning.

What are the best arguments for this?
- Higher achievement/competence/mastery => higher intrinsic motivation. But not the other way around, at least a population level
	- Maybe Montessori's autonomy aspects don't actually matter that much and it's more the focus on competence/achievement/mastery? And you can recreate that outside of Montessori if your kid is smart & goes to a strong public school?
- It might be extremely kid dependent. Maybe some kids need the structure of a traditional education? In other words the three aspects in self-determination theory of competence, autonomy, relatedness, may matter differing amounts for each kid. Perhaps Montessori is too high a dose of autonomy for some kids.
- I think I am making an implicit assumption that my kid will be smart enough that they would outpace traditional education quickly / will value learning in and of itself in some fashion? In other words they will be similar to me. That may not be true at all.
	- Yea I guess maybe none of these studies apply since by definition they are all population level and I am thinking on the individual level. Lol. But that's always oging to be an issue so w/e.
	- Even if this assumption is false... ideally I would still like to foster intrinsic motivation for independent learning, or at least AVOID the hatred of public school/learning (or at least certain topics within it eg math) that seems to be a fairly common case

Yea I think an even more specific version of what I care about is:
	Montessori schooling is more effective than traditional schooling at fostering intrinsic motivation in students for independent learning, or at minimum avoiding instilling hatred of learning.


And the inverse could expand to:
	Montessori schooling is equally or less effective than traditional schooling at fostering intrinsic motivation in students for independent learning. It has an equal or higher chance of instilling hatred of learning in students as traditional schooling.

It would make me sad if we had a kid who hated learning. My view is that kids instinctively want to learn things (it's really all they know how to do...), and that desire has to be "taken away" from them in some way, which happens most commonly thru public schooling.

Is it possible that we have a kid who just instinctively / naturally doesn't like learning? I find that scenario hard to believe? I am not defining learning as narrow academic learning here, so it seems impossible unless the kid has a developmental disorder or something?

I mean if you believe Judith Harris Nurture Assumption & [Henrik essay](https://asteriskmag.com/issues/07/culture-studies), it's ultimately about culture. Finding a culture, selecting a peer group, that values learning. I really think this could be a huge side effect of actually doing dinner parties/board walks type stuff, and modeling the culture within it like we want. Build that culture! Build that exceptional milieu for our kid to grow up in and ask real questions of adults. I need to get better at this too, just asking interesting questions that make ppl think.
