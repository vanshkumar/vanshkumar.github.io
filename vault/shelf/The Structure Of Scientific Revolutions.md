...
The hypothesis a scientist choose to test in the first place, how they set up their experiment, whether they interpret their results as theory-falsifying or an experimental error. All of these things are heavily influenced by **what they already believe** – what Kuhn calls the current scientific paradigm.
...
One of the classic examples is the [precession of Mercury](https://en.wikipedia.org/wiki/Tests_of_general_relativity#Classical_tests). Mercury's precession was observed to deviate from what Newtonian physics would predict in 1859. Instead of this anomaly immediately leading to a major upheaval of Newtonian physics, various ad-hoc solutions were proposed, including the suggestion of a hypothetical planet named [Vulcan](https://en.wikipedia.org/wiki/Vulcan_(hypothetical_planet)). It took **56 years** for this to be resolved by Einstein's theory of general relativity.
