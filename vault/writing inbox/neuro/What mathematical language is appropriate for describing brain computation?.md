...
- Random matrix theory / universality classes → [[writing inbox/neuro/Can universality class distribution results from random matrix theory help us understand neural population dynamics?]]
- Kolmogorov complexity / minimum description length → [[writing inbox/neuro/What might a useful analog to Kolmogorov Complexity in the brain look like?]]
- Feedback control theory → [[writing inbox/neuro/How does DNA bridge the micro (local neuronal rules) to the macro (evolutionarily relevant behavior)?]]
